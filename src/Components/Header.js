...
const Header = ({ inputRef, handleSearch, darkMode, handleDark }) => {
  return (
    <header className="-mt-1 sm:mt-0 dark:bg-gray-600/20 fixed grid grid-cols-1 grid-rows-2 sm:grid-rows-1 sm:grid-cols-3 w-full sm:py-1.5 sm:px-3 p-1.5 justify-between bg-gray-400/10 backdrop-blur-[3px] border-b border-gray-600 z-20">
      <button
